...
var $author$project$Page$init = A3($author$project$Page$Model, '', '', '');
...
var $author$project$Page$Name = function (a) {
	return {$: 'Name', a: a};
};
var $author$project$Page$Password = function (a) {
	return {$: 'Password', a: a};
};
var $author$project$Page$PasswordAgain = function (a) {
...
var $author$project$Page$viewInput = F4(
...
var $author$project$Page$viewValidation = function (model) {
...
var $author$project$Page$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A4($author$project$Page$viewInput, 'text', 'Name', model.name, $author$project$Page$Name),
				A4($author$project$Page$viewInput, 'password', 'Password', model.password, $author$project$Page$Password),
				A4($author$project$Page$viewInput, 'password', 'Re-enter Password', model.passwordAgain, $author$project$Page$PasswordAgain),
				$author$project$Page$viewValidation(model)
			]));
};
